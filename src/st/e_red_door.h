...
void OVL_EXPORT(EntityRedDoor)(Entity* self) {
    ...
    case 0:
        ...
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, LEN(g_eRedDoorUV));
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
