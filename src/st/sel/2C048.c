...
static void InitMainMenuUI(void) {
    ...
    D_801BAF18[GFX_UNK_0][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    i = 0;
    y = 0;
    x = -0x20;
    ...
    for (; i < NUM_MENU_OPTIONS; i++) {
        D_801BAF18[i + 1][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    ...
    D_801BAF18[6][0] = g_api.AllocPrimRecursively(PRIM_GT4, 4);
    ...
    D_801BAF18[7][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    ...
    D_801BAF18[8][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    ...
    D_801BAF18[9][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 3);
    ...
    D_801BAF18[10][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    ...
    D_801BAF18[GFX_WND_SAVE_SUMMARY][0] = g_api.AllocPrimRecursively(PRIM_GT4, 1);
    ...
    D_801BAF18[GFX_UNK_12][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 8);
    func_801AC084(0xC, 0);

    D_801BAF18[GFX_WND_CARD_1][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
    ...
    D_801BAF18[GFX_WND_CARD_2][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
    ...
    D_801BAF18[15][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
    ...
    D_801BAF18[16][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
    ...
    D_801BAF18[17][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
    ...
    D_801BAF18[18][0] = g_api.AllocPrimRecursively(PRIM_GT4, 2);
    ...
    D_801BAF18[19][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 8);
    func_801AC084(0x13, -0x28);

    D_801BAF18[20][0] = g_api.AllocPrimRecursively(PRIM_SPRT, 1);
...
static void InitMainMenuBackgroundAndFadeMask(void) {
    ...
    primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 3);
    ...
    // with fading it out.
    primIndex = g_api.AllocPrimRecursively(PRIM_TILE, 2);
    prim = &g_PrimBuf[primIndex];
