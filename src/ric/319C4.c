...
void func_8016D9C4(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_LINE_G2, 20);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntityCrashReboundStoneExplosion(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_G4, 0x10);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntityCrashBibleBeam(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_G4, BIBLE_PAGE_COUNT);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntityCrashBible(Entity* self) {
    ...
    case 0:
        self->primIndex =
            g_api.AllocPrimRecursively(PRIM_GT4, 1 + BIBLE_PAGE_COUNT);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            g_Player.unk4E = 1;
            return;
...
void func_8016F198(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, PrimCount);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            g_Player.unk4E = 1;
            return;
...
void RicEntityCrashStopwatchDoneSparkle(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 20);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntityAguneaLightning(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 0xF);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntitySubwpnStopwatchCircle(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 0x10);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntitySubwpnStopwatch(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 3);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
        ...
        if (self->ext.ricStopWatch.crashIndex < 2) {
            g_unkGraphicsStruct.g_PauseFlag = 1;
        }
        self->step++;
        break;
    case 1:
...
void RicEntitySubwpnBibleTrail(Entity* entity) {
    ...
    switch (entity->step) {
    case 0:
        ret = g_api.AllocPrimRecursively(PRIM_GT4, 1);
