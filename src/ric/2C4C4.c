...
void RicEntitySubwpnCrashCrossParticles(Entity* self) {
    ...
    if (self->step == 0) {
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 0x20);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntitySubwpnAxe(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 5);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntitySubwpnDagger(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 2);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntitySubwpnReboundStone(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_LINE_G2, 16);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
...
void RicEntityAguneaHitEnemy(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_GT4, 0x28);
        if (self->primIndex == -1) {
        block_71:
            DestroyEntity(self);
            break;
...
void RicEntityCrashVibhuti(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        self->primIndex = g_api.AllocPrimRecursively(PRIM_TILE, 9);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            g_Player.unk4E = 1;
            return;
