...
extern Vram g_Vram;
extern s32 g_PlayerHitCooldown;
...
#endif
extern s32 PlayerLedgeTimer;         // These two might...
...
extern unkstr_800cfe48* g_AnimationData[18];
...
void InitializeBackbufferCoords(s32);
...
void HandlePlayerKill(DamageParam* damage, s16 arg1, s16 arg2);
void UpdatePlayerPositionInTopStage(void);
void AssignEntityEnemyId(Entity*);
...
void EntityGravityBootsBeam(Entity* self);
...
void EntityPlayerColorBlend(Entity* self);
